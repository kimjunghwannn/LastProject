...
#ifndef LASTPROJECT_SWIFT_H
#define LASTPROJECT_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="LastProject",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC11LastProject11AppDelegate")
...
SWIFT_CLASS("_TtC11LastProject13SceneDelegate")
...
@interface ViewController (SWIFT_EXTENSION(LastProject)) <MKMapViewDelegate>
